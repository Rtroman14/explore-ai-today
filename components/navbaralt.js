...
export default function NavbarAlt(props) {
    const menu = [
        ...
        },
        {
            ...
            href: "/",
            children: [
                { title: "ChatGPT", path: "/category/chatgpt" },
                {
                    title: "News",
                    path: "/category/news"
                },
                { title: "Tools", path: "/category/tools" },
                { title: "Tutorials", path: "/category/tutorial" }
            ]
        },
        {
            label: "Tools",
                ...
                <Disclosure>
                    {({ open }) => (
                        <>
                            ...
                            <Disclosure.Panel>
                                <div className="order-2  mt-5 flex w-full flex-col items-start justify-start lg:hidden">
                                    {/* <div className="order-2  mt-5 flex w-full flex-col items-center justify-start lg:hidden"> */}
                                    {menu.map((item, index) => (
                                        <>
                                            {item.children &&
                                            item.children.length >
